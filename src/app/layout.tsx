...
export const metadata: Metadata = {
  title: "QuasarNova - AI Automation for Service Businesses",  description: "AI voice receptionists and backend automation for HVAC, plumbing, and service businesses. Capture every lead. Eliminate manual work. Drive revenue.",  keywords: "AI automation, voice receptionist, lead capture, HVAC software, plumbing software, business automation, AI chatbot",  metadataBase: new URL("https://quasarnova.io"),
  alternates: {
    canonical: "https://quasarnova.io"
  },
  openGraph: {
    title: "QuasarNova - AI Automation for Service Businesses",    description: "Stop losing leads. Start capturing revenue. AI voice receptionists and workflow automation built for ambitious service businesses.",    url: "https://quasarnova.io",    siteName: "QuasarNova",    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3ASWsvHXewt6s2gJbyu1sTGroNA/a-futuristic-ai-automation-dashboard-int-1772595822858-293a29b7.png",        alt: "QuasarNova AI Automation Dashboard"
      }
    ],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",    title: "QuasarNova - AI Automation for Service Businesses",    description: "Stop losing leads. Start capturing revenue with AI voice receptionists.",    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3ASWsvHXewt6s2gJbyu1sTGroNA/a-futuristic-ai-automation-dashboard-int-1772595822858-293a29b7.png"]
  },
  robots: {
    index: true,
    follow: true
